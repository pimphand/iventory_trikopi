        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Starter Page</h4>
                    ...
                    <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="text-sm font-medium text-slate-700 dark:text-slate-400"
                                aria-current="page">Starter Page</a>
                        </div>
                    </div>
                </div>
                <!-- Page Title End -->
                ...
                <div class="divide-y divide-dashed divide-slate-900/10  dark:divide-white/10">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div class="card-radio">
                                <input class="form-radio" type="radio" name="data-sidenav-view" id="sidenav-view-hover"
                                    value="hover">
                            ...
                            <div class="card-radio">
                                <input class="form-radio" type="radio" name="data-sidenav-view" id="sidenav-view-mobile"
                                    value="mobile">
                            ...
                            <div class="card-radio">
                                <input class="form-radio" type="radio" name="data-sidenav-view" id="sidenav-view-hidden"
                                    value="hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <div class="card-radio">
                                <input class="form-radio" type="radio" name="data-topbar-color" id="topbar-color-light"
                                    value="light">
                            ...
                            <div class="card-radio">
                                <input class="form-radio" type="radio" name="data-topbar-color" id="topbar-color-brand"
                                    value="brand">
